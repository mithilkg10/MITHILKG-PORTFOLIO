...
export const cyberLab = {
  categories: [
    {
      name: "Systems & Cloud",
      skills: ["Linux Kernel", "Docker", "Kubernetes", "AWS (IAM, EC2, S3)", "Apache Kafka"],
      roles: ["General", "Cloud Security Engineer", "DevSecOps Engineer", "Backend Engineer", "Software Engineer", "Cybersecurity Engineer"],
    },
    {
      name: "Languages",
      skills: ["Python (Advanced)", "Go (Intermediate)", "TypeScript", "SQL", "Bash/Shell"],
      roles: ["General", "Software Engineer", "Backend Engineer", "Data Scientist", "AI / ML Engineer", "Application Security Engineer"],
    },
    {
      name: "Security Engineering",
      skills: ["Threat Modeling", "Intrusion Detection (Snort/Zeek)", "Burp Suite", "EDR Analytics", "Post-Quantum Cryptography concepts"],
      roles: ["General", "SOC Analyst", "Threat Intelligence Analyst", "Application Security Engineer", "DFIR Analyst", "Cybersecurity Engineer", "GRC Analyst"],
    },
    {
      name: "AI & Data Engineering",
      skills: ["PyTorch", "TensorFlow", "XGBoost", "Pandas", "Time-Series Forecasting"],
